...
-- -----------------------------------------------------
-- test
DROP SCHEMA IF EXISTS `deliver_schema` ;
...
-- test
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `deliver_schema` ;
USE `sakila` ;
...
-- -----------------------------------------------------
-- Table `deliver_schema`.`store`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deliver_schema`.`store` (
  `store_idx` INT NOT NULL AUTO_INCREMENT,
  `store_name` VARCHAR(20) NOT NULL DEFAULT '매장 이름',
  `store_num` VARCHAR(13) NULL DEFAULT '매장 번호',
  `store_address` VARCHAR(45) NOT NULL DEFAULT '매장 주소',
  PRIMARY KEY (`store_idx`),
  UNIQUE INDEX `store_idx_UNIQUE` (`store_idx` ASC, `store_address` ASC, `store_num` ASC, `store_name` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `deliver_schema`.`store_menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deliver_schema`.`store_menu` (
  `store_index` INT NOT NULL DEFAULT store fk 인덱스 COMMENT 'store 테이블 idx 외래키\n',
  `menu_name` VARCHAR(45) NOT NULL,
  `menu_price` INT NOT NULL,
  `menu_desc` VARCHAR(45) NULL,
  PRIMARY KEY (`store_index`),
  UNIQUE INDEX `store_index_UNIQUE` (`store_index` ASC, `menu_name` ASC, `menu_price` ASC),
  CONSTRAINT `store_index`
    FOREIGN KEY (`store_index`)
    REFERENCES `deliver_schema`.`store` (`store_idx`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deliver_schema`.`customer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deliver_schema`.`customer` (
  `customer_idx` INT NOT NULL AUTO_INCREMENT,
  `customer_name` VARCHAR(45) NOT NULL,
  `customer_id` VARCHAR(45) NULL,
  `customer_num` VARCHAR(13) NOT NULL,
  `customer_add` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`customer_idx`),
  UNIQUE INDEX `customer_idx_UNIQUE` (`customer_idx` ASC, `customer_name` ASC, `customer_add` ASC, `customer_num` ASC),
  INDEX ())
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `deliver_schema`.`rider`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deliver_schema`.`rider` (
  `rider_idx` INT NOT NULL AUTO_INCREMENT,
  `rider_name` VARCHAR(45) NOT NULL,
  `rider_num` VARCHAR(13) NOT NULL,
...
-- -----------------------------------------------------
-- Table `deliver_schema`.`charge_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deliver_schema`.`charge_type` (
...
-- -----------------------------------------------------
-- Table `deliver_schema`.`order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deliver_schema`.`order` (
  `order_idx` INT NOT NULL AUTO_INCREMENT,
  `store_idx` INT NOT NULL,
  `store_menu` VARCHAR(45) NOT NULL,
  `store_menu_price` INT NOT NULL,
  ...
  INDEX `store_menu_name_idx` (`store_menu` ASC, `store_menu_price` ASC),
  INDEX `store_idx_idx` (`store_idx` ASC),
  INDEX `c_idx_idx` (`customer_idx` ASC),
  INDEX `c_add_idx` (`customer_idx` ASC, `c_address` ASC, `s_address` ASC),
  INDEX `s_add_idx` (`s_address` ASC),
  INDEX `c_type_idx` (`charge_type` ASC),
  INDEX `order_time` (`order_time` ASC),
  CONSTRAINT `store_idx`
    FOREIGN KEY (`store_idx`)
    REFERENCES `deliver_schema`.`store` (`store_idx`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `store_menu_name`
    FOREIGN KEY (`store_menu` , `store_menu_price`)
    REFERENCES `deliver_schema`.`store_menu` (`menu_name` , `menu_price`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_idx`
    FOREIGN KEY (`customer_idx`)
    REFERENCES `deliver_schema`.`customer` (`customer_idx`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_add`
    FOREIGN KEY (`customer_idx` , `c_address` , `s_address`)
    REFERENCES `deliver_schema`.`customer` (`customer_idx` , `customer_add` , `customer_name`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `s_add`
    FOREIGN KEY (`s_address`)
    REFERENCES `deliver_schema`.`store` (`store_address`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_type`
    FOREIGN KEY (`charge_type`)
    REFERENCES `deliver_schema`.`charge_type` (`idx`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `deliver_schema`.`order_finish`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `deliver_schema`.`order_finish` (
  `finish_idx` INT NOT NULL AUTO_INCREMENT,
  `order_idx` INT NULL,
  ...
  PRIMARY KEY (`finish_idx`),
  INDEX `o_idx_idx` (`order_idx` ASC),
  INDEX `c_idx_idx` (`customer_idx` ASC),
  INDEX `r_idx_idx` (`rider_idx` ASC),
  INDEX `c_add_idx` (`customer_address` ASC),
  INDEX `o_time_idx` (`order_time` ASC),
  CONSTRAINT `o_idx`
    FOREIGN KEY (`order_idx`)
    REFERENCES `deliver_schema`.`order` (`order_idx`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_idx`
    FOREIGN KEY (`customer_idx`)
    ...
    ON UPDATE NO ACTION,
  CONSTRAINT `r_idx`
    FOREIGN KEY (`rider_idx`)
    REFERENCES `deliver_schema`.`rider` (`rider_idx`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `c_add`
    FOREIGN KEY (`customer_address`)
    REFERENCES `deliver_schema`.`customer` (`customer_add`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `o_time`
    FOREIGN KEY (`order_time`)
    REFERENCES `deliver_schema`.`order` (`order_time`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
